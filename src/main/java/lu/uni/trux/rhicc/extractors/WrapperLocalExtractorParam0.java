...
public class WrapperLocalExtractorParam0 extends WrapperLocalExtractorImpl {
	...
	public WrapperLocalExtractorParam0(WrapperLocalExtractorImpl next) {
		...
		this.methods.add(Constants.COM_PARSE_NOTIFICATIONCOMPAT$BUILDER_SETCONTENTINTENT);
		this.methods.add(Constants.COM_PARSE_NOTIFICATIONCOMPAT$BUILDER_SETDELETEINTENT);

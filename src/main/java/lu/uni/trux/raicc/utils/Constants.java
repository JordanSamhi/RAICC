...
public class Constants {
	...
	public static final String COM_PARSE_NOTIFICATIONCOMPAT$BUILDER_SETCONTENTINTENT = "<com.parse.NotificationCompat$Builder: com.parse.NotificationCompat$Builder setContentIntent(android.app.PendingIntent)>";
	public static final String COM_PARSE_NOTIFICATIONCOMPAT$BUILDER_SETDELETEINTENT = "<com.parse.NotificationCompat$Builder: com.parse.NotificationCompat$Builder setDeleteIntent(android.app.PendingIntent)>";
